...
const AD_SLOTS = [
  ...
  {
    id: 'featured',
    name: 'Featured Venue or Event',
    description: 'Highlight your wine bar, wine store, winery, or event in the Featured section on the relevant directory page and on the homepage carousel.',
    placement: 'Wine Bars, Wine Stores, Wineries, or Events page + homepage',
  ...
  {
    id: 'acker',
    name: 'Auction Sidebar Ad',
    description: 'Your ad sits in the Wine Auctions sidebar on the homepage Events section — a high-visibility spot seen by collectors and enthusiasts browsing auction listings.',
    placement: 'Homepage events sidebar (Auctions tab)',
