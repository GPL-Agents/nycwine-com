...
const AD_SLOTS = {
  ...
  featured: {
    ...
    icon:        '⭐',
    placement:   'Directory page + homepage',
    size:        'Logo + name + address card',
    monthlyRate: 25,
    description: 'Your venue or event highlighted in the Featured sidebar and on the homepage.',
  },
  acker: {
    ...
    size:        '300 × 90 px',
    monthlyRate: 100,
    description: 'Reach collectors browsing the Wine Auctions section on the homepage.',
  },
  borghese: {
    name:        'Social Page Ad',
    icon:        '📱',
